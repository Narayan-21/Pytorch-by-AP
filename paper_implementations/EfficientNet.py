...
params = {
    # tuple of: (phi_values, resolution, drop_rate)
    "b0":  (0,224,0.2),
    "b1": (0.5,240,0.2),
    "b2": (1,260,0.3),
    "b3": (2,300,0.3),
...
class CNNBlock(nn.Module):
    #groups=1: Normal Convolution, groups=in_channels = depthwise convolution.
...
# Squeeze and Excitation block => https://paperswithcode.com/method/squeeze-and-excitation-block for more..
...
class EfficientNet(nn.Module):
    ...
    def calculate_factors(self, version, alpha=1.2, beta=1.1):
        phi, res, drop_rate = params[version]
